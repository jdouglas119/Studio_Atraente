...
begin
   If Application.Messagebox('Confirma Cancelamento de Autorizador? ', 'Confirmação',
...
begin
   If Application.Messagebox('Confirma Alteração de Autorizador? ', 'Confirmação',
   mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
   else
   exit;
   cod.ReadOnly := false;
...
begin
   If Application.Messagebox('Confirma Gravação de Autorizador? ', 'Confirmação',
   mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
   else
   exit;
   cod.ReadOnly := true;
...
begin // Inserindo registros na tabela
   If Application.Messagebox('Confirma Inclusão de Autorizador? ', 'Confirmação',
   mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
   else
   exit;
   cod.ReadOnly := false;
