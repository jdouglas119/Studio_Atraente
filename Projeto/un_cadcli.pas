...
type
  Tfrm_cadcli = class(TForm)
    ...
    procedure cont_visExit(Sender: TObject);
...
procedure Tfrm_cadcli.cont_visExit(Sender: TObject);
begin
{   dt_studio.tb_movservico.Edit;
   dt_studio.tb_movservicoCONT_VISITAS.Value := dt_studio.tb_cadcliCONT_VISITAS.Value;
...
procedure Tfrm_cadcli.sButton2Click(Sender: TObject);
begin//Deletar foto do cadastro de clientes
   dt_studio.tb_cadcli.Edit;
   gravar.Enabled := true;
   cancelar.Enabled := true;
   foto.Picture := nil;
...
procedure Tfrm_cadcli.sButton3Click(Sender: TObject);
var
   jpg: TJpegImage;
