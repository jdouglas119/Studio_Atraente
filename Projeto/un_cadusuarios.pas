...
begin // Cancelar registros na tabela
  If Application.Messagebox('Confirma Cancelamento da Digitação de Usuários? ',
...
begin // Alterando registros na tabela
  If Application.Messagebox('Confirma Alteração de Usuários? ', 'Confirmação',
...
begin
  Case Key of
       ...
       begin
          If Application.Messagebox('Confirma Inclusão de Usuários? ', 'Confirmação',
          mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
          else
          exit;
          id_codigo.ReadOnly := false;
  ...
  Case Key of
       ...
       begin
          If Application.Messagebox('Confirma Gravação de Usuários? ', 'Confirmação',
          mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
          else
          exit;
          id_codigo.ReadOnly := true;
