                  ...
                  begin
                     ...
                     if RecordCount > 0 Then
                        begin
                           ...
                           frm_chama_rel_comissoes.rv_comissao.SetParam('periodo' , Datini.Text + ' até ' + DatFim.Text);
                        ...
                        End
                     Else
                        Showmessage('Não Existe(m) Comissão(ões) para esse Período!!!');
                  End;
           except
               Showmessage('Existe(m) Erro(s) no Relatório de Comissões!!!');
           end;
         End;
       1:Begin
           Try
             with dt_studio.qry_comissao do
                  begin
                     ...
                     if RecordCount > 0 Then
                        ...
                        Showmessage('Não existe Comissão para esse Atendente Nesse Período!!!');
                     Close;
                  End;
           except
               Showmessage('Existe(m) Erro(s) no Relatório de Comissões!!!');
