...
begin // Exortando movimentos do caixa
   dt_studio.tb_movcaixa.Edit;
   usuario2.Text := dt_studio.tb_cadusu.FieldByName('NOM_APELIDO').AsString;
   es_novo.Enabled := true;
   fecha.Enabled := false;
