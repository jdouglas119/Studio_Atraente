...
begin // Controle dos botões
   ...
   //TRABALHAR NIVEIS DE ACESSO AO SISTEMA DE ACORDO COM O NIVEL DO USUÁRIO
...
begin
  ...
  If Application.Messagebox('Deseja Realmente Sair do Sistema? ', 'Confirmação',
...
begin
  // Iformações de Data Hora e usuarios//
