...
procedure Tfrm_resumo.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  totalgeral: Currency;
  subtotal: Currency;
...
procedure Tfrm_resumo.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  totalgeral: Currency;
  subtotal: Currency;
