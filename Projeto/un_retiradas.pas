...
begin //Cancelando digitação na tabela
   ...
   ('Confirma Cancelamento de Retirada ou Pagamento do Caixa? ', 'Confirmação',
...
begin //Gravando informações na tabela
   If Application.Messagebox
   ('Confirma Gravação de Retirada ou Pagamento do Caixa? ', 'Confirmação',
   mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
   else
   exit;
...
begin //Verificando informção da abertura do caixa e incluindo registros na tabela
   ...
   If Application.Messagebox('Confirma Lançamento de Retirada ou Pagamento do Caixa? ', 'Confirmação',
   mb_Iconquestion + Mb_OkCancel + Mb_DefButton1) = IdOk then
   else
   exit;
